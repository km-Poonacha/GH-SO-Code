...
# 			else:
	...
	df.to_excel(r'C:\Users\pmedappa\Dropbox\Research\GH-SO\GH-SO-Project\Data\Counterfactual\CleanConsolidatedSponsors_india_DirtyCounterfactual_SOMatch_confirm.xlsx', encoding='utf-8-sig', index=False, header=['github username', 'stack ID'])
