...
def expandSponsors(df_spon):
    ...
    for i,row in df_spon.iterrows():
        ...
        if (pd.notna(row['sponsorshipsAsMaintainer_nodes_12_2_21'])):
...
def main():
    ...
    w_spon_xl = r"C:\Users\pmedappa\Dropbox\Data\Sponsors\SO_Panel.xlsx"
    w_spon_xl_mp = r"C:\Users\pmedappa\Dropbox\Data\Sponsors\SO_MonthPanel.xlsx"
